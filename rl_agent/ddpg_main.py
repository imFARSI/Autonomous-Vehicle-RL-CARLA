...
MONITOR_DIR = './logs/{}/{}/pic_ddpg'.format(FLAGS.env_name, DATETIME)
# Directory for storing tensorboard summary results
SUMMARY_DIR = './logs/{}/{}/tf_ddpg'.format(FLAGS.env_name, DATETIME)
# Directory for storing model
MODEL_DIR = './models/{}/{}/tf_net'.format(FLAGS.env_name, DATETIME)
