...
from tensorflow.compat.v1.keras.layers import Dense, Input, Conv2D, AveragePooling2D, Activation, Flatten, Concatenate, MaxPooling2D
...
class ActorNetwork_CNN:
    ...
    def generate_model(self):
        ...
        conv0 = Conv2D(FILTERS_CONV, KERNEL_CONV, padding='same', activation='relu', kernel_initializer='uniform', name='conv0')(input_layer)
