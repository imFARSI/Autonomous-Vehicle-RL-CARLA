...
from tensorflow.compat.v1.keras.layers import Dense, Input, add, Conv2D, Concatenate, Flatten, AveragePooling2D, MaxPooling2D, concatenate
...
class CriticNetwork_CNN:
    ...
    def generate_model(self):
        ...
        conv0 = Conv2D(FILTERS_CONV, KERNEL_CONV, padding='same', activation='relu', kernel_initializer='uniform', name='conv0')(state_input)
