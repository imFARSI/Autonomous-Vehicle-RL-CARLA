...
# Dynamic paths - automatically loads the latest weights for current TRAIN_MODE
# This enables automatic training resume from the last saved checkpoint
actor_weights_file  = save_weights_path + str(TRAIN_MODE) + "_actor.h5"
critic_weights_file = save_weights_path + str(TRAIN_MODE) + "_critic.h5"

# Commented out old hardcoded paths (kept for reference):
